...
\section*{Awards}% 賞（@award 型 or keywords=awards）
\printbibliography[type=award, heading=none]
% もし @award ではなく keywords=awards を使うなら ↓ に置換
% \printbibliography[keyword=awards, heading=none]

\section*{Grants}% 研究費（@grant 型 or keywords=grants）
\printbibliography[type=grant, heading=none]
% \printbibliography[keyword=grants, heading=none]
