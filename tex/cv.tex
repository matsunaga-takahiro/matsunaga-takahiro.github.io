...
\defbibfilter{journal}{\type{article} or \keyword{journal-article}}
...
% \subsubsection*{Ph.D. in Civil Engineering, the University of Tokyo \quad (\textit{Since 2025.10})}
% \subsubsection*{M.S. in Civil Engineering, the University of Tokyo (Outstanding Paper Award) \quad \textit{2024.04 - 2025.09}}
% \subsubsection*{B.S. in Civil Engineering, the University of Tokyo (Best Paper Award) \quad \textit{2020.04 - 2024.03}}
% \subsubsection*{Ph.D. in Civil Engineering, the University of Tokyo \makebox[\linewidth][r]{\textit{Since 2025.10}}}
% \subsubsection*{M.S. in Civil Engineering, the University of Tokyo (Outstanding Paper Award) \makebox[\linewidth][r]{\textit{2024.04 -- 2025.09}}}
% \subsubsection*{B.S. in Civil Engineering, the University of Tokyo (Best Paper Award) \makebox[\linewidth][r]{\textit{2020.04 -- 2024.03}}}
...
% \subsection*{Journal Articles}% 査読誌だけ
% \printbibliography[type=article, heading=none]
\printbibliography[filter=journal, title={Journal Articles}]

% \subsection*{International Conferences}% 国際会議だけ（@inproceedings かつ keywords に conference-international）
\printbibliography[filter=conf-intl, title={International Conferences}]

% \subsection*{Domestic Conferences}% 国内会議だけ
\printbibliography[filter=conf-dom, title={Domestic Conferences}]

% \section*{Grants}% 研究費（@grant 型 or keywords=grants）
